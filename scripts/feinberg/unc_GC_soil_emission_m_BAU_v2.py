...
np.savetxt("misc_Data/unc_Amazon_emiss_BAU_v2.csv", Amazon_emiss, delimiter=",")
np.savetxt("misc_Data/unc_global_emiss_BAU_v2.csv", global_emiss, delimiter=",")

savemat("misc_Data/unc_emiss_map_BAU_v2.mat", {"Hg_soil_emiss_ann": Hg_soil_emiss_ann})
