...
fn_ols025 = 'misc_Data/Olson_2001_Land_Type_Masks.025x025.generic_sav58.nc'
...
#%% 
# load SAV Hg0 species concentration, for use in dry deposition flux calculations
fn_Hg0 = '../GEOS-Chem_runs/run0315/OutputDir/GEOSChem.SpeciesConc.alltime_m.nc4'
...
np.savetxt("misc_Data/unc_Amazon_dep_SAV.csv", Amazon_dep, delimiter=",")
...
sio.savemat('misc_Data/unc_drydepflux_m_SAV_Am.mat', {"DF": DF_ann})
