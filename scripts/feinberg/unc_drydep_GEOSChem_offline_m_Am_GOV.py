...
# Land type LAI
fn_xlai  = 'misc_Data/GOV/LAI/Yuan_proc_MODIS_XLAI.025x025.GOV_2050_m.nc'
...
# Land type areas
fn_ols2 = 'misc_Data/Olson_Land_Type_Mask.2_25.GOV_2050.nc'
...
fn_ols025 = 'misc_Data/GOV/LAI/Olson_Land_Type_Masks.025x025.GOV_2050.nc'
...
#%% 
# load GOV Hg0 species concentration, for use in dry deposition flux calculations
fn_Hg0 = '../GEOS-Chem_runs/run0313/OutputDir/GEOSChem.SpeciesConc.alltime_m.nc4'
...
np.savetxt("misc_Data/unc_Amazon_dep_GOV.csv", Amazon_dep, delimiter=",")
...
sio.savemat('misc_Data/unc_drydepflux_m_GOV_Am.mat', {"DF": DF_ann})
