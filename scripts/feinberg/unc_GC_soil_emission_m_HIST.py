...
for j in range(num):
    ...
    print(Amazon_emiss[j])
    print(global_emiss[j])


# save data to csv, for access
np.savetxt("misc_Data/unc_Amazon_emiss_HIST_v2.csv", Amazon_emiss, delimiter=",")
np.savetxt("misc_Data/unc_global_emiss_HIST_v2.csv", global_emiss, delimiter=",")

# save data to .mat
Hg_soil_emiss_ann_u = np.float32(Hg_soil_emiss_ann) # convert to smaller units for storage
savemat("misc_Data/unc_emiss_map_HIST_v2.mat", {"Hg_soil_emiss_ann": Hg_soil_emiss_ann_u})

#savemat("misc_Data/unc_emiss_map_HIST.mat", {"Hg_soil_emiss_ann": Hg_soil_emiss_ann})
