...
np.savetxt("misc_Data/unc_Amazon_emiss_GOV.csv", Amazon_emiss, delimiter=",")
np.savetxt("misc_Data/unc_global_emiss_GOV.csv", global_emiss, delimiter=",")

savemat("misc_Data/unc_emiss_map_GOV.mat", {"Hg_soil_emiss_ann": Hg_soil_emiss_ann})
