---
title: "Analyse des concentrations modélisées de Hg⁰ (2015)"
...
---
title: "Comparaison modèle vs. observations Hg0"
author: "Martin Colomb"
date: "`r Sys.Date()`"
output:
  html_document:
...
```{r multi-scenario, echo=TRUE}
scenarios <- c("B10",  "B20",  "B30", "B40", "V3")
chem_base <- "14_3_1/HIST_"
all_results <- data.frame()

species_conc_B30 <- nc_open(file.path("14_3_1/HIST_B30", "GEOSChem.SpeciesConc.2015_m.nc4"))
