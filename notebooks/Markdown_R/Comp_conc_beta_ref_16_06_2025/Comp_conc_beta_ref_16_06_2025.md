...
![](Comp_conc_beta_ref_16_06_2025_files/figure-gfm/comparaison-plot-1.png)<!-- -->

# Comparaison multi-scénarios

``` r
scenarios <- c("V3", "B10",  "B20",  "B30", "B40", "B100", "B150", "B200" )
...
palette_b <- c("V3" = "black", "B10" = "#52e3e1" ,"B20" = "#fdf148" , "B30" ="#d883ff" , "B40" ="#9336fd", "B100" = "#33a8c7" , "B150" = "#ffab00", "B200" = "#a0e426" )
...
![](Comp_conc_beta_ref_16_06_2025_files/figure-gfm/multi-scenario-1.png)<!-- -->
